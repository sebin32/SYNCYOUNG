		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SYNC YOUNG - FI] 미결/반제 전표 조회",
									"targetURL": "#cl3syncyoungfidocfidocument-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3syncyoungfidocfidocument-display": {
								"semanticObject": "cl3syncyoungfidocfidocument",
								"action": "display",
								"description": "[SYNC YOUNG - FI] 미결/반제 전표 조회",
								"title": "[SYNC YOUNG - FI] 미결/반제 전표 조회",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.syncyoung.fi.doc.fi.document",
									"url": sap.ui.require.toUrl("cl3/syncyoung/fi/doc/fi/document")
								}
							}
						}
					}

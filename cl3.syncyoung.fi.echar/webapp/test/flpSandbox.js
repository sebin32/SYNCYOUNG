		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[ SYNC YOUNG - FI ] 환차손, 환차익 차트",
									"targetURL": "#cl3syncyoungfiecharcl3syncyoungfiechar-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3syncyoungfiecharcl3syncyoungfiechar-display": {
								"semanticObject": "cl3syncyoungfiecharcl3syncyoungfiechar",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.syncyoung.fi.echar.cl3.syncyoung.fi.echar",
									"url": sap.ui.require.toUrl("cl3/syncyoung/fi/echar/cl3/syncyoung/fi/echar")
								}
							}
						}
					}
